    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-4">
                ...
                <a class="dropdown-item <?php echo ($detail == 'kepala_dusun_I') ? 'active' : ''; ?>" href="?detail=kepala_dusun_I">Kepala Dusun I </a>
                <a class="dropdown-item <?php echo ($detail == 'kepala_dusun_II') ? 'active' : ''; ?>" href="?detail=kepala_dusun_II">Kepala Dusun II</a>
            ...
            <div class="col-md-8">
                <?php if ($detail == 'struktur_organisasi') : ?>
                    ...
                    <img src="assets/img/STRUKTUR.JPG" class="w-100" alt="">
                ...
                <?php elseif ($detail == 'kasi_kesejahteraan') : ?>
                    ...
                    <p>Kepala Seksi Pemerintahan atau biasa disingkat Kasi Pemerintahan adalah perangkat desa yang mempunyai kedudukan sebagai unsur pelaksana teknis yang ditugaskan membantu Kepala Desa sebagai pelaksana tugas operasional dibidang pemerintahan desa.<br> <br>
                        ...
                        <?php elseif ($detail == 'kasi_kesejahteraan') : ?>
                    <h2 class="text-left text-primary mb-2">Kasi pelayanan</h2>
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>OSWALDUS SEDA BUSA,S.SI</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
                    ...
                    <p>Kepala Seksi Pemerintahan atau biasa disingkat Kasi Pemerintahan adalah perangkat desa yang mempunyai kedudukan sebagai unsur pelaksana teknis yang ditugaskan membantu Kepala Desa sebagai pelaksana tugas operasional dibidang pemerintahan desa.<br> <br>
                        ...
                        <?php elseif ($detail == 'kasi_kesejahteraan') : ?>
                    <h2 class="text-left text-primary mb-2">Kaur Tur& Umum</h2>
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>SEKEUS NUGA WEA,S.T</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
                ...
                <?php elseif ($detail == 'kasi_keuangan') : ?>
                    <h2 class="text-left text-primary mb-2">Kaur Keuangan</h2>
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>HERIBERTUS MOLA,AMD</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
                ...
                <?php elseif ($detail == 'kepala_dusun_I') : ?>
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>HILARIUS T.TANI UNA,S.E</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
                            <td>Kepala Dusun I </td>
                        </tr>
                        <tr>
                            <td>Nip</td>
                            <td>:</td>
                ...
                <?php elseif ($detail == 'kepala_dusun_II') : ?>
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>SEBASTIANUS MEO</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
                            <td>Kepala Dusun II </td>
                        </tr>
                        <tr>
                            <td>Nip</td>
                            <td>:</td>
                ...
                <?php elseif ($detail == 'kepala_dusun_III') : ?>
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>SILVESTER EMANUEL GU,S.PD</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
