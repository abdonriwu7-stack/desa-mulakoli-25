...
<div class="container">
    ...
    <h4 class="mb-3">Demografi Desa Mulakoli</h4>
    <div class=" d-flex justify-content-center">
        <img src="assets/img/KANTOR 1.jpg" class="w-100 mb-3" alt="">
    </div>
    <div class="text-left">
        <h6 class="text-uppercase">JUMLAH PENDUDUK DESA Mulakoli TAHUN 2025-2026</h6>
